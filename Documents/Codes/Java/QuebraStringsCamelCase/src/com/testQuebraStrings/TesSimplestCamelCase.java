...
public class TesSimplestCamelCase {
	...
	/**
	 * Testa a conversão de uma palavra com a primeira letra maiúscula. A palavra
	 * deve ser convertida para minúscula.
	 */
	@Test
	...
	/**
	 * Testa a conversão de uma string CamelCase com múltiplas palavras. O método
	 * deve separar as palavras corretamente.
	 */
	@Test
	...
	/**
	 * Testa a conversão de uma string vazia. O resultado esperado é uma lista
	 * vazia.
	 */
	@Test
	...
	/**
	 * Testa a conversão de uma string com apenas um caractere. O resultado esperado
	 * é o caractere convertido para minúscula.
	 */
	@Test
	...
	/**
	 * Testa a conversão de uma string contendo apenas espaços em branco. O
	 * resultado esperado é uma lista vazia.
	 */
	@Test
	...
	/**
	 * Testa a conversão de uma string contendo um hífen como separador. O hífen
	 * deve ser tratado como um separador de palavras.
	 */
	@Test

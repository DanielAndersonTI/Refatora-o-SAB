...
public class ConverterCamelCase {
	...
	/**
	 * Converte uma string no formato CamelCase em uma lista de palavras. A função
	 * divide a string em palavras, mantendo a primeira letra de cada palavra, trata
	 * caracteres especiais e converte as palavras para minúsculas, exceto aquelas
	 * que são siglas (todas maiúsculas).
	 * 
	...
	public static List<String> converterCamelCase(String original) {
		...
		for (char c : original.toCharArray()) {
			...
			// Se o caractere não for uma letra ou número e houver uma palavra em
			// construção,
			// adiciona a palavra à lista e reinicia o StringBuilder
